...
cd $OpenCV_Dir
if [ ! -d "${OPENCV_SOURCE_DIR}/opencv/" ] ; then
  echo "path :$OPENCV_SOURCE_DIR/opencv/ not exist, now create it"
  tar -zxvf opencv-kumar-4.1.1.tar.gz
  cp -rf ${OpenCV_Dir}/opencv ${OPENCV_SOURCE_DIR}/opencv
else
  echo "path :$OPENCV_SOURCE_DIR/opencv/ exist !"
fi

if [ ! -d "$OPENCV_SOURCE_DIR/opencv_contrib/" ] ; then
  echo "path :$OPENCV_SOURCE_DIR/opencv_contrib/ not exist, now create it"
  tar -zxvf opencv_contrib-kumar-4.1.1.tar.gz
  cp -rf ${OpenCV_Dir}/opencv_contrib ${OPENCV_SOURCE_DIR}/opencv_contrib
else
  echo "path :${OPENCV_SOURCE_DIR}/opencv_contrib/ exist !"
fi
